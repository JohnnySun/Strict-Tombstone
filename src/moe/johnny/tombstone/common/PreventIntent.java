package moe.johnny.tombstone.common;

import android.net.Uri;

import moe.johnny.tombstone.Manifest;
...
public final class PreventIntent {
    ...
    public static final String NAMESPACE = "moe.johnny.tombstone.";
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://moe.johnny.tombstone.provider");
