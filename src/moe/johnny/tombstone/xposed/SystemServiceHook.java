package moe.johnny.tombstone.xposed;
...
import moe.johnny.tombstone.framework.PreventLog;
import moe.johnny.tombstone.framework.PreventRunning;
import moe.johnny.tombstone.framework.util.ActivityRecordUtils;
import moe.johnny.tombstone.framework.util.ProcessRecordUtils;
import moe.johnny.tombstone.framework.util.ReflectUtils;
import moe.johnny.tombstone.framework.util.TaskRecordUtils;
...
public class SystemServiceHook extends XC_MethodHook {
    ...
    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
        ...
        try {
            Class.forName("moe.johnny.tombstone", false, classLoader);
